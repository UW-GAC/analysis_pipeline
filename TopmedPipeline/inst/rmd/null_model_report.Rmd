...
---
title: "Null model Report `r if (!is.null(params$intermediate) & params$intermediate) "- intermediate model"`"
---
...
nullmod_file <- config["out_file"]
if (params$intermediate) {
  nullmod_file <- gsub(".RData", "_intermediate.RData", nullmod_file)
  config["inverse_normal"] <- FALSE
}
config["null_model_file"] <- nullmod_file
